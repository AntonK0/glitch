...
MuseScore {
    ...
    function processCommand(command) {
        ...
        switch(command.action) {
            ...
            case "getInstrumentList":       return getInstrumentList(command.params);
    ...
    function processSequence(params) {
        ...
        var validCommands = [
            ...
            "setStaffMute", "setInstrumentSound", "setTempo", "getInstrumentList"
        ];
    ...
    function getInstrumentList(params) {
        if (!curScore) return { error: "No score open" };
        ...
        try {
            ...
            for (var i = 0; i < curScore.nstaves; i++) {
                ...
                list.push({
                    ...
                    instrumentId: staff.part.instrumentId
                });
            }
