...
def setup_navigation_tools(mcp, client: MuseScoreClient):
    ...
    async def get_score_info():
        """Retrieve a list of all tracks/staves and their instrument names."""
        # This sends a custom command to your MuseScore plugin
        # which must be programmed to return a list of parts.
        return await client.send_command("getInstrumentList")
